"use strict";(self.webpackChunk_N_E=self.webpackChunk_N_E||[]).push([[358],{5002:function(e,t,n){n.d(t,{ET:function(){return sp},IO:function(){return i7},JU:function(){return iL},QT:function(){return sf},Xo:function(){return sr},ad:function(){return iF},cf:function(){return sy},hJ:function(){return ix},pl:function(){return sg}});var r,i,s,a,o=n(9279),l=n(2680),u=n(9053),h=n(3943),c=n(6552),d=n(4575);n(357);var f=n(6300).Buffer;let m="@firebase/firestore";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function sf(e){e=iA(e,iD);let t=iA(e.firestore,iO);return(function(e,t,n={}){let r=new A;return e.asyncQueue.enqueueAndForget(async()=>(function(e,t,n,r,i){let s=new id({next:o=>{s.Za(),t.enqueueAndForget(()=>rq(e,a));let l=o.docs.has(n);!l&&o.fromCache?i.reject(new S(C.UNAVAILABLE,"Failed to get document because the client is offline.")):l&&o.fromCache&&r&&"server"===r.source?i.reject(new S(C.UNAVAILABLE,'Failed to get document from server. (However, this document does exist in the local cache. Run again without setting source to "server" to retrieve the cached document.)')):i.resolve(o)},error:e=>i.reject(e)}),a=new rK(e5(n.path),s,{includeMetadataChanges:!0,_a:!0});return rU(e,a)})(await iw(e),e.asyncQueue,t,n,r)),r.promise})(iP(t),e._key).then(n=>sw(t,e,n))}class sm extends so{constructor(e){super(),this.firestore=e}convertBytes(e){return new iU(e)}convertReference(e){let t=this.convertDocumentKey(e,this.firestore._databaseId);return new iD(this.firestore,null,t)}}function sg(e,t,n){e=iA(e,iD);let r=iA(e.firestore,iO),i=sl(e.converter,t,n);return sv(r,[iY(iH(r),"setDoc",e._key,i,null!==e.converter,n).toMutation(e._key,tx.none())])}function sp(e,t){let n=iA(e.firestore,iO),r=iL(e),i=sl(e.converter,t);return sv(n,[iY(iH(e.firestore),"addDoc",r._key,i,null!==e.converter,{}).toMutation(r._key,tx.exists(!1))]).then(()=>r)}function sy(e,...t){var n,r,i;let s,a,o;e=(0,h.m9)(e);let l={includeMetadataChanges:!1,source:"default"},u=0;"object"!=typeof t[0]||iM(t[u])||(l=t[u],u++);let c={includeMetadataChanges:l.includeMetadataChanges,source:l.source};if(iM(t[u])){let e=t[u];t[u]=null===(n=e.next)||void 0===n?void 0:n.bind(e),t[u+1]=null===(r=e.error)||void 0===r?void 0:r.bind(e),t[u+2]=null===(i=e.complete)||void 0===i?void 0:i.bind(e)}if(e instanceof iD)a=iA(e.firestore,iO),o=e5(e._key.path),s={next:n=>{t[u]&&t[u](sw(a,e,n))},error:t[u+1],complete:t[u+2]};else{let n=iA(e,ib);a=iA(n.firestore,iO),o=n._query;let r=new sm(a);s={next:e=>{t[u]&&t[u](new sd(a,r,n,e))},error:t[u+1],complete:t[u+2]},/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function(e){if("L"===e.limitType&&0===e.explicitOrderBy.length)throw new S(C.UNIMPLEMENTED,"limitToLast() queries require specifying at least one orderBy() clause")}(e._query)}return function(e,t,n,r){let i=new id(r),s=new rK(t,i,n);return e.asyncQueue.enqueueAndForget(async()=>rU(await iw(e),s)),()=>{i.Za(),e.asyncQueue.enqueueAndForget(async()=>rq(await iw(e),s))}}(iP(a),o,c,s)}function sv(e,t){return function(e,t){let n=new A;return e.asyncQueue.enqueueAndForget(async()=>r3(await iv(e).then(e=>e.syncEngine),t,n)),n.promise}(iP(e),t)}function sw(e,t,n){let r=n.docs.get(t._key),i=new sm(e);return new sh(e,i,t._key,r,new su(n.hasPendingWrites,n.fromCache),t.converter)}new WeakMap,function(e=!0){p=o.Jn,(0,o.Xd)(new l.wA("firestore",(t,{instanceIdentifier:n,options:r})=>{let i=t.getProvider("app").getImmediate(),s=new iO(new D(t.getProvider("auth-internal")),new V(t.getProvider("app-check-internal")),function(e,t){if(!Object.prototype.hasOwnProperty.apply(e.options,["projectId"]))throw new S(C.INVALID_ARGUMENT,'"projectId" not provided in firebase.initializeApp.');return new ev(e.options.projectId,t)}(i,n),i);return r=Object.assign({useFetchStreams:e},r),s._setSettings(r),s},"PUBLIC").setMultipleInstances(!0)),(0,o.KN)(m,"4.7.3",void 0),(0,o.KN)(m,"4.7.3","esm2017")}()}}]);