...
export const createComment = async (
  ...
  const avatar = user.photoURL || `https://ui-avatars.com/api/?name=${encodeURIComponent(displayName)}&background=0A84FF&color=fff&bold=true`;

  if (displayName === "Ẩn danh") {
    throw new TaskCommentError("Vui lòng cập nhật tên hiển thị trong Profile");
  }
