...
export default function TasksPage() {
  ...
  return (
    <>
      ...
      <div
        className="min-h-screen bg-white dark:bg-black text-zinc-900 dark:text-zinc-100 select-none pb-28"
      ...
      >
        ...
        <div className="sticky top-0 z-40 bg-white/80 dark:bg-zinc-950/80 backdrop-blur-xl border-b border-zinc-200 dark:border-zinc-800">
          ...
          <div className="px-4 pt-3 pb-2">
            <div className="bg-[#F2F2F7] dark:bg-zinc-900 rounded-xl p-1 flex gap-1">
            ...
            <div className="flex gap-2">
              {SUB_TABS.map((tab) => (
                <button
                  ...
                  className={`px-4 h-8 rounded-full text-[13px] font-medium whitespace-nowrap transition-all active:scale-95 ${
                    subTab === tab.key
          ...
          {loading ? (
            ...
            <div className="bg-white dark:bg-zinc-900 rounded-2xl border border-zinc-200 dark:border-zinc-800 p-12 text-center">
              ...
              <p className="text-[14px] text-zinc-500 mb-4">
                {subTab === "mine" &&
                  `Tạo ${mainTab} đầu tiên của bạn`}

                {subTab === "saved" &&
                  `Lưu ${mainTab} để xem sau`}

                {subTab === "doing" &&
                  `Nhận ${mainTab} để bắt đầu làm`}

                {subTab === "applied" &&
                  `Ứng tuyển ${mainTab} phù hợp`}

                {subTab === "completed" &&
                  `Hoàn thành ${mainTab} đầu tiên`}
              </p>
              ...
              {subTab === "mine" && (
                <button
                  ...
                  className={`px-5 h-10 rounded-xl ${theme.bgLight} text-white text-[14px] font-medium active:scale-95 transition-all`}
                >
                  Tạo ngay
                </button>
              )}
