...
export default function TermsPage() {
  ...
  const docLottie = "/lotties/huha-celebrate-full.lottie";
        ...
        >
          ...
          <div className="text-center mb-6">
            <div className="relative w-20 h-20 mx-auto mb-4">
              ...
              <div className="relative w-full h-full bg-gradient-to-br from-[#0042B2] to-[#1A5FFF] rounded-3xl flex items-center justify-center shadow-xl">
                <DotLottieReact src={docLottie} autoplay loop style={{width:44,height:44}} />
              </div>
            </div>
            <h1 className="text-2xl font-black text-zinc-900 dark:text-white mb-1.5 tracking-tight">Điều khoản sử dụng HUHA</h1>
            <p className="text-sm text-zinc-500">Phiên bản {version} | Cập nhật: {lastUpdated}</p>
          </div>
          ...
          <div className="space-y-5 text-sm text-zinc-700 dark:text-zinc-300 max-h-[60vh] overflow-y-auto pr-2 custom-scrollbar">
            <section>
              ...
              <p className="leading-relaxed">HUHA là ứng dụng mạng xã hội do <b style={{color:'#0042B2'}}>Nguyễn Quốc Mạnh</b> phát triển và vận hành. Bằng việc tạo tài khoản và sử dụng HUHA, bạn đồng ý bị ràng buộc bởi Điều khoản này và Chính sách bảo mật.</p>
            </section>
            ...
            <section>
              ...
              <p className="leading-relaxed">Bạn giữ toàn bộ quyền với nội dung bạn đăng. Mã nguồn, logo, thương hiệu "HUHA" thuộc sở hữu của Nguyễn Quốc Mạnh.</p>
            </section>
            ...
            <section className="bg-[#0042B2]/5 dark:bg-[#0042B2]/10 border border-[#0042B2]/20 rounded-3xl p-5">
              <h2 className="font-bold text-zinc-900 dark:text-white mb-3 flex items-center gap-2 text-base">
                <FiUser size={18} style={{color:'#0042B2'}} />
              ...
              <div className="space-y-2.5 text-zinc-700 dark:text-zinc-300">
                ...
                <p className="flex items-center gap-2"><FiMail style={{color:'#0042B2'}} size={16} /><b>Email:</b> Manhgopatel5@gmail.com</p>
