...
import { FiFileText, FiPhone, FiMail, FiUser, FiAlertTriangle, FiBriefcase, FiAward } from "react-icons/fi";
        ...
        >
          ...
          <div className="space-y-6 text-sm font-semibold text-zinc-700 dark:text-zinc-300">
            ...
            <section>
              ...
              <p>
                huha là nền tảng kết nối công việc do <b>Nguyễn Quốc Mạnh</b> phát triển. Dịch vụ gồm: ứng dụng mobile, website huha.online, API. 
            ...
            <section>
              ...
              <ul className="space-y-2">
                ...
                <li className="flex gap-2"><span className="mt-0.5 h-4 w-4 shrink-0 rounded-full bg-[#0A84FF]" /><span>Bảo mật mật khẩu. Báo ngay cho DPO nếu nghi ngờ bị xâm phạm qua admin@huha.online</span></li>
            ...
            <section className="rounded-2xl border-2 border-[#0A84FF]/20 bg-[#0A84FF]/5 p-4 dark:bg-[#0A84FF]/10">
              ...
              <div className="space-y-2.5 text-zinc-800 dark:text-zinc-200">
                ...
                <p className="flex items-center gap-2"><FiMail className="text-[#0A84FF]" size={16} /><b>Email:</b> admin@huha.online</p>
