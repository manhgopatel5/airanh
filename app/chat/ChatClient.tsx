      ...
      <div className="min-h-screen bg-white dark:bg-black select-none">
            ...
            <div className="flex items-center gap-2.5">
              <div className="relative flex-1">
                ...
                <input
                  ...
                  className="w-full h-[38px] pl-[34px] pr-3.5 bg-[#f2f2f7] dark:bg-zinc-900 rounded-[10px] text-[15px] font-normal outline-none border-0 focus:bg-white dark:focus:bg-zinc-900 focus:ring-2 focus:ring-[#0a84ff]/20 transition-all placeholder:text-gray-400"
                  autoComplete="off"
                  autoCorrect="off"
                />
              </div>
              ...
              <button
                ...
                className="w-[38px] h-[38px] bg-[#0a84ff] hover:bg-[#007aff] active:bg-[#0051d5] rounded-[10px] flex items-center justify-center shadow-sm active:scale-95 transition-all duration-150"
                aria-label="Tạo mới"
              >
                <RiAddLine
            ...
            <div className="flex items-center gap-5 mt-3.5 px-0.5 overflow-x-auto scrollbar-hide">
              {[
                ...
                <button
                  ...
                  className={`relative py-2 text-[15px] whitespace-nowrap transition-colors duration-200 ${
                    activeTab === tab.key
                ...
                >
                  {tab.label}
                  {activeTab === tab.key && (
                    <div className="absolute -bottom-[1px] left-0 right-0 h-[2.5px] bg-black dark:bg-white rounded-full" />
                  )}
                </button>
              ))}
          ...
          {loading? (
            ...
            <div className="flex flex-col items-center justify-center min-h-[60vh] px-8 text-center">
              ...
              {activeTab === "all" && (
                <button
                  onClick={() => setShowAdd(true)}
                  className="mt-6 px-5 h-[36px] bg-[#0a84ff] hover:bg-[#007aff] active:bg-[#0051d5] text-white rounded-full text-[14px] font-medium shadow-sm active:scale-95 transition-all duration-150"
                >
                  Tạo mới
                </button>
              )}
            ...
            <div>
              ...
              {pinnedChats.length > 0 && (
                <div className="px-4 pt-3 pb-1">
                  <p className="text-[12px] font-medium text-[#8e8e93] dark:text-zinc-500 uppercase tracking-wider">
                    Đã ghim
                  </p>
                </div>
              )}
                ...
                {[...pinnedChats,...normalChats].map((chat) => (
                  <div key={chat.chatId} className="group relative">
                    <Link
                      ...
                      className="flex items-center gap-3 px-4 py-[10px] active:bg-black/[0.04] dark:active:bg-white/[0.06] transition-colors duration-150"
                    >
                      {/* Avatar */}
                      ...
                      <div className="flex-1 min-w-0 py-1">
                        <div className="flex items-baseline justify-between gap-2 mb-0.5">
                          ...
                          <div className="flex items-center gap-1.5 flex-shrink-0">
                            ...
                            {chat.unreadCount? (
                              <span className="min-w-[20px] h-5 px-1.5 bg-[#0a84ff] rounded-full flex items-center justify-center">
                        ...
                        <div className="flex items-center gap-1">
                          {chat.isTyping? (
                            <div className="flex items-center gap-1.5">
                              ...
                              <span className="text-[14px] leading-[19px] text-[#0a84ff] italic">
                                đang nhập
                              </span>
                            </div>
                          ) : (
                    ...
                    <div className="md:hidden flex items-center justify-end gap-4 px-4 pb-2 -mt-1">
                      <button
                        ...
                        className="text-[13px] text-[#0a84ff] font-medium py-1 px-2 active:opacity-60 transition-opacity"
                      >
                        {pinned.includes(chat.chatId)? "Bỏ ghim" : "Ghim"}
                      </button>
                      <button
                        onClick={() => handleDeleteChat(chat)}
                        className="text-[13px] text-[#ff3b30] font-medium py-1 px-2 active:opacity-60 transition-opacity"
                      >
                        Xóa
                      </button>
                    </div>
        ...
        {showAdd && (
          <div className="fixed inset-0 z-50 flex items-start justify-center pt-6 p-4">
            ...
            {/* Modal */}
            <div className="relative w-full sm:max-w-[380px] bg-[#f5f5f7] dark:bg-zinc-900 sm:rounded-[20px] rounded-t-[20px] shadow-2xl max-h-[85vh] flex flex-col animate-in slide-in-from-bottom duration-300">
              {/* Handle bar (mobile) */}
                ...
                <div className="grid grid-cols-2 gap-1 p-1 bg-black/[0.04] dark:bg-white/[0.06] rounded-[10px]">
                  {[
                    ...
                    <button
                      ...
                      className={`h-[30px] rounded-[7px] text-[14px] font-[550] flex items-center justify-center gap-1.5 transition-all duration-200 ${
                        addMode === tab.id
...
/>
                    ...
                    <button
                      ...
                      className="w-full h-[44px] bg-[#0a84ff] hover:bg-[#007aff] active:bg-[#0051d5] disabled:opacity-40 text-white rounded-[12px] text-[16px] font-[550] transition-all active:scale-[0.98] flex items-center justify-center gap-2"
                    >
                      {adding && (
                  ...
                  <div className="flex-1 flex flex-col min-h-0 space-y-3">
                    <input
                      ...
                      className="w-full h-[44px] px-3.5 bg-white dark:bg-zinc-800 border border-black/10 dark:border-white/10 rounded-[12px] text-[16px] outline-none focus:border-[#0a84ff] focus:ring-4 focus:ring-[#0a84ff]/10 transition-all"
                      maxLength={30}
                    />
                    ...
                    <div className="flex-1 bg-white dark:bg-zinc-800 rounded-[12px] border border-black/10 dark:border-white/10 overflow-hidden flex flex-col min-h-0">
                      <div className="px-3 py-2.5 bg-white/80 dark:bg-zinc-800/80 backdrop-blur border-b border-black/5 dark:border-white/5 flex-shrink-0">
                        <p className="text-[13px] font-medium text-[#8e8e93] dark:text-zinc-500">
                            ...
                            {friendsForGroup.map((person) => (
                              ...
                              >
                                <input
                                  ...
                                  className="w-[20px] h-[20px] rounded-[6px] border-2 border-[#c7c7cc] dark:border-zinc-600 text-[#0a84ff] focus:ring-0 focus:ring-offset-0 checked:bg-[#0a84ff] checked:border-[#0a84ff] transition-colors"
                                />
                                <img
                                  src={person.avatar}
                                  alt={person.name}
                                ...
                                <div className="flex-1 min-w-0">
                                  <p className="text-[15px] leading-5 font-normal truncate">
                                    {person.name}
                                  </p>
                                  <p className="text-[13px] leading-4 text-[#8e8e93] dark:text-zinc-500">
                    ...
                    <button
                      ...
                      className="w-full h-[44px] bg-[#0a84ff] hover:bg-[#007aff] active:bg-[#0051d5] disabled:opacity-40 text-white rounded-[12px] text-[16px] font-[550] transition-all active:scale-[0.98] flex items-center justify-center gap-2 flex-shrink-0"
                    >
                      {adding && (
                        <FiLoader className="animate-spin" size={18} />
                      )}
