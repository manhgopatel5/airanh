...
export default function EditTaskPage() {
  ...
  const validate = () => {
    ...
    if (!form.price || form.price < 1000) newErrors.price = "Giá tối thiểu 1.000đ";
    if (!form.totalSlots || form.totalSlots < 1) newErrors.totalSlots = "Số người tối thiểu 1";
    if (task && form.totalSlots && form.totalSlots < task.joined) {
      ...
      <div className="min-h-screen bg-gray-50 dark:bg-zinc-950 pb-24">
        <div className="sticky top-0 bg-white/80 dark:bg-zinc-900/80 backdrop-blur-xl border-b border-gray-100 dark:border-zinc-800 z-40">
          <div className="max-w-2xl mx-auto px-4 py-3 flex items-center justify-between">
            ...
            <h1 className="font-bold text-gray-900 dark:text-gray-100">Sửa công việc</h1>
            <button
        ...
        <form onSubmit={handleUpdate} className="max-w-2xl mx-auto px-4 py-6 space-y-6">
          <div>
            ...
            <input
              ...
              placeholder="VD: Cần người thiết kế logo"
            />
          ...
          <div>
            ...
            <input
              ...
              className="w-full px-4 py-3 rounded-xl border border-gray-200 dark:border-zinc-700 bg-white dark:bg-zinc-900 text-gray-900 dark:text-gray-100 focus:ring-2 focus:ring-blue-500 outline-none"
              placeholder="VD: Thiết kế, Lập trình"
            />
          </div>
          ...
          <button
            type="submit"
            disabled={saving}
            className="w-full py-3.5 rounded-2xl text-white font-semibold bg-gradient-to-r from-blue-500 to-indigo-600 shadow-lg shadow-blue-500/30 active:scale-[0.98] transition-all disabled:opacity-50 flex items-center justify-center gap-2"
          >
            {saving ? (
              <>
