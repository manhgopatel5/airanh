        ...
        <div className="max-w-2xl mx-auto p-4">
          {loading? (
            ...
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="bg-card rounded-3xl border border-border p-12 text-center">
              <FiInbox className="w-16 h-16 mx-auto mb-4 text-muted-foreground/30" />
          ...
          {loadingMore && <div className="flex justify-center py-6"><FiRefreshCw className="w-6 h-6 animate-spin text-primary" /></div>}
