    ...
    <div className="min-h-screen bg-zinc-50 dark:bg-black flex items-center">
      <div className="w-full max-w-lg mx-auto px-4 py-12">
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="text-center mb-10">
          <motion.div initial={{ scale: 0.8, opacity: 0 }} animate={{ scale: 1, opacity: 1 }} transition={{ type: "spring", stiffness: 200, delay: 0.1 }} className="inline-flex items-center gap-2 px-3.5 py-2 rounded-2xl bg-white dark:bg-zinc-950 border border-zinc-200/60 dark:border-zinc-800 shadow-sm mb-6">
        ...
        <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.4 }} className="mt-10">
          <div className="p-4 rounded-2xl bg-white dark:bg-zinc-950 border border-zinc-200/60 dark:border-zinc-800 text-center">
        ...
        {/* Quick stats */}
        <motion.div initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.5 }} className="mt-8 grid grid-cols-3 gap-3">
          {[
            { label: "Công việc", value: "12.5K+" },
            { label: "Kế hoạch", value: "8.3K+" },
            { label: "Thành công", value: "94%" },
          ].map((stat) => (
            <div key={stat.label} className="text-center p-3 rounded-2xl bg-white/50 dark:bg-zinc-950/50 backdrop-blur-sm border border-zinc-200/40 dark:border-zinc-800/40">
