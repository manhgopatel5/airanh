      ...
      <div key={msg.id}>
        ...
        >
          ...
          <div className={`max-w-[75%] flex flex-col ${isMe? 'items-end' : 'items-start'}`}>
            ...
            {/* Poll bo tròn full */}
            <div className="px-4 py-3 rounded-[20px] bg-zinc-100 dark:bg-zinc-800 w-full">
                      ...
                      <div className="relative px-3 py-2.5">
                        ...
                        {opt.votes.length > 0 && (
                          <div className="flex -space-x-1">
                            ...
                            {opt.votes.length > 5 && (
                              <div className="w-5 h-5 rounded-full bg-zinc-300 dark:bg-zinc-600 border border-white dark:border-zinc-800 flex items-center justify-center text-[10px] text-zinc-600 dark:text-zinc-300">
                                +{opt.votes.length - 5}
                              </div>
                            )}
                          </div>
    ...
    <div key={msg.id}>
      ...
      >
        ...
        <div className={`max-w-[75%] flex flex-col ${isMe? 'items-end' : 'items-start'}`}>
          ...
          {/* Bong bóng bo tròn full - KHÔNG còn rounded-tr-[4px] */}
