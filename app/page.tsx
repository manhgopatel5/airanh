...
import celebrateAnimation from "@/public/lotties/huha-celebrate.json";
import emptyAnimation from "@/public/lotties/huha-empty.json";
import walletAnimation from "@/public/lotties/huha-wallet-open.json";
              ...
              return (
                ...
                >
                  <Icon
                    size={20}
                    className={
                      active ? "" : "text-gray-400 dark:text-zinc-500"
                    }
                    style={{
