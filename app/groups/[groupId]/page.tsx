...
export default function GroupChatPage() {
  ...
  return (
    <div className="flex flex-col h-screen bg-white dark:bg-black">
      {/* Header */}
      <div className="flex flex-col border-b border-black/10 dark:border-white/10 bg-white/80 dark:bg-zinc-900/80 backdrop-blur-xl sticky top-0 z-10">
 ...
 ? 'bg-[#0a84ff] text-white rounded-[18px] rounded-br-[4px]'
  ...
  <p className="text-[15px] leading-[20px] whitespace-pre-wrap break-words">{msg.text}</p>
      ...
      {typingUsers.length > 0 && (
        <div className="px-4 pb-1 text-xs text-[#8e8e93] italic">
