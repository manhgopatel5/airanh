...
<div className="bg-white dark:bg-zinc-900 text-zinc-900 dark:text-white rounded-3xl p-5 border border-zinc-200 dark:border-zinc-800 shadow-xl shadow-zinc-900/5 dark:shadow-black/20">
...
{userVip?.tier === 'pro' && selectedTierId === 'elite' && (
 <div className="bg-amber-500/10 border border-amber-500/30 rounded-3xl p-4 shadow-lg shadow-amber-500/10">
...
<div className="bg-white dark:bg-zinc-900 rounded-3xl p-5 border border-zinc-200 dark:border-zinc-800 shadow-xl shadow-zinc-900/5 dark:shadow-black/20">
                  ...
                  <div className="flex gap-2">
                    ...
                    <button
                      ...
                      disabled={!promoCode}
className="px-6 h-12 bg-[#0a84ff] text-white rounded-2xl text-sm font-bold disabled:opacity-40 active:scale-95 transition-all shadow-xl shadow-blue-500/30"
                    >
                      Áp dụng
                    </button>
                  </div>
...
<div className="bg-emerald-500/10 border border-emerald-500/30 rounded-3xl p-4 flex items-center justify-between shadow-lg shadow-emerald-500/10">
...
<div className="relative bg-white dark:bg-zinc-900 rounded-3xl p-6 border-2 border-zinc-200 dark:border-zinc-800 shadow-2xl shadow-zinc-900/10 dark:shadow-black/30">
                {(() => {
...
{tier.id === 'pro' && (
  <div className="absolute -top-3 left-6 px-3 py-1 bg-[#0a84ff] rounded-full shadow-xl shadow-blue-500/50">
...
{tier.id === 'elite' && (
  <div className="absolute -top-3 left-6 px-3 py-1 bg-amber-500 rounded-full shadow-xl shadow-amber-500/50">
    <span className="text-xs font-bold text-white flex items-center gap-1">
  ...
  <div className="flex flex-col gap-1">
    {appliedPromo && (
      <div className="flex items-center gap-2">
        ...
        <span className="px-2 py-0.5 bg-red-500 text-white text-xs font-bold rounded-md shadow-md shadow-red-500/30">
  ...
  {tier.features.map((feat, i) => {
    ...
    return (
      <div key={i} className="flex items-start gap-3">
        <div className={cn(
          "w-5 h-5 rounded-lg flex items-center justify-center flex-shrink-0 mt-0.5 shadow-sm",
          tier.id === 'elite'? 'bg-amber-500/10 shadow-amber-500/20' : 'bg-[#0a84ff]/10 shadow-blue-500/20'
        )}>
          <Icon
            className={cn(
              tier.id === 'elite'? 'text-amber-500' : 'text-[#0a84ff]'
...
<button
  ...
  className={cn(
    ...
    ? 'bg-emerald-500 text-white cursor-not-allowed shadow-xl shadow-emerald-500/40'
      : tier.id === 'elite'
      ? 'bg-amber-500 text-white shadow-2xl shadow-amber-500/50 hover:shadow-amber-500/70 hover:scale-[1.02]'
        : 'bg-[#0a84ff] text-white shadow-2xl shadow-blue-500/50 hover:shadow-blue-500/70 hover:scale-[1.02]'
  )}
>
  {!isActive && userVip?.tier!== 'elite' && (
