    ...
    <AnimatePresence mode="wait">
      {isOpen && (
        <>
          ...
          {/* FIX: Dùng fixed inset-x-0 flex justify-center thay vì left-1/2 */}
          <div className="fixed inset-x-0 bottom-20 z-50 flex justify-center px-4 pointer-events-none">
            ...
            >
              <div className="bg-white/90 dark:bg-zinc-900/90 backdrop-blur-2xl rounded- p-3 shadow-2xl shadow-black/10 dark:shadow-black/30 ring-1 ring-black/5 dark:ring-white/10">
                <div
                ...
                <div className="grid grid-cols-2 gap-2.5">
                  ...
                  >
                    ...
                    <div className="relative z-10 text-center">
                      <h4 className="font-black text-zinc-900 dark:text-zinc-100 text- tracking-tight leading-tight">
                        Hỗ trợ tức thì
                      </h4>
                      <p className="text- text-zinc-500 dark:text-zinc-400 font-semibold mt-1 leading-tight">
                  ...
                  >
                    ...
                    <motion.div
                      className="absolute inset-0 rounded-3xl opacity-0 group-hover:opacity-100 transition-opacity duration-500"
                      style={{
                        boxShadow: `inset 0 1px 0 0 rgba(255,255,0.1), 0 8px 32px -8px ${THEME.plan.primary}40`
                      }}
                    />
                ...
                <motion.p
                  ...
                  className="text- text-center text-zinc-400 dark:text-zinc-600 font-medium mt-2"
                >
                  Vuốt xuống để đóng
                </motion.p>
              </div>
